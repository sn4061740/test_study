...
public class P2PTrans {
    ...
    public static String stopById(int port,String streamId) {
        String url1=LOCAL_HOST + ":" + port + "/bt/api/stream/stop?id="+streamId;
        url1=getUrlAddPass(url1);
        Log.e("TAG","停止的URL:"+url1);
        return httpGet(url1);
    }
    ...
    public static String getTorrentPlayUrl(String url) {
        return LOCAL_HOST + ":" + BaseCommon.P2P_SERVER_PORT + "/bt/stream?type=tfile&uri=" + url;
    }

    public static String getTorrentPlayPath(int port, String path) {
        return LOCAL_HOST + ":" + port + "/bt/stream?type=tfile&uri=" + path;//+"&pass=urlsphvhcoupnlcteviqhnoanvbkdqyp&priv=1"
    }
    public static String getLocalTorrentPath(String path) {
        return LOCAL_HOST + ":" + BaseCommon.P2P_SERVER_PORT + "/bt/api/stream/start?type=tfile&uri=" + path;//+"&pass=urlsphvhcoupnlcteviqhnoanvbkdqyp&priv=1"
    }
    public static String getTorrentUrlPath(String path){
        return String.format(Locale.CHINA, "%s:%d/bt/api/stream/start?type=%s&uri=%s", P2PTrans.LOCAL_HOST,
                BaseCommon.P2P_SERVER_PORT, P2PTrans.P2P_TYPE,path);
    }
    public static String getM3u8UriPath(String uri){
        return LOCAL_HOST + ":" + BaseCommon.HTTP_PORT + "/start?uri={"+uri+"}";
    }
    public static String getM3u8PlayPath(String uri,String v){
        return LOCAL_HOST + ":" + BaseCommon.HTTP_PORT + "/start?uri={"+uri+"}&priv=1&v1="+v;
    }
    public static String getM3u8PlayUrl(String uri,String v){
        return LOCAL_HOST + ":" + HttpServerManager.PORT + "/start?v1="+v+"&uri={"+uri+"}";
    }
    //local
    public static String getM3u8PlayUrlV1(String uri,String v){
        return LOCAL_HOST + ":" + HttpServerManager.PORT + "/play?v1="+v+"&uri={"+uri+"}";
    }
    ...
    public static String getM3u8Play(String uri,String v){
        if(uri.contains("?")) {
            return uri + "&priv=1&v1=" + v;
        }else{
            return uri+"?priv=1&v1="+v;
        }
    }
    public static String setUri(String uri,String v){
        return uri+"?priv=1&v1="+v;
    }
    ...
    public static String getStreamInfoUrl(String path) {
        return LOCAL_HOST + ":" + BaseCommon.P2P_SERVER_PORT + "/bt/api/streaminfo?id=" + path;
    }
    //帮助
     ...
     * @return 返回添加后的路径地址
     */
    public static String getUrlAddPass(final String url){
        String xUrl=url;
