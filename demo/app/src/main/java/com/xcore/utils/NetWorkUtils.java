...
public class NetWorkUtils {
     ...
     * @return int
     */
    public static String getOperatorName(Context context1) {
        try {
            /*
            ...
            String v= telephonyManager.getSimOperatorName();// getSimOperatorName();
     ...
     * @return int
     */
    public static int getNetworkState(Context context1) {
        try {
            Context context = context1;
            if (context == null) {
                context = MainApplicationContext.context;
