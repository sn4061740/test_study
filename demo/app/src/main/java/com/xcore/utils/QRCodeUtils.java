...
import com.xcore.zxing.BarcodeFormat;
import com.xcore.zxing.BitMatrix;
import com.xcore.zxing.CharacterSetECI;
import com.xcore.zxing.EncodeHintType;
import com.xcore.zxing.ErrorCorrectionLevel;
import com.xcore.zxing.QRCodeWriter;
import com.xcore.zxing.WriterException;

import java.util.Hashtable;

public class QRCodeUtils {
    public static void qrCode(String url, ImageView imageView, int width, int height){
        try {
            Bitmap qrCode = createQRCodeBitmap(url, width);
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size,String margin,Bitmap bitmap){
        return createQRCodeBitmap(content, size, "UTF-8", "H", margin, Color.BLACK, Color.WHITE, null, bitmap, 0.3F);
    }
