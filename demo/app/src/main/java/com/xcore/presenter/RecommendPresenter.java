...
public class RecommendPresenter extends BasePresent<RecommendView> {
   ...
   public void getNvStarRecommend(final int pageIndex){
       ...
       ApiFactory.getInstance().<NvStarBean>getNvStarRecommend(params, new TCallback<NvStarBean>() {
           @Override
   ...
   public void getRecommendData(){
       ...
       try {
           ApiFactory.getInstance().<RecommendBean>getRecommends(new TCallback<RecommendBean>() {
               @Override
