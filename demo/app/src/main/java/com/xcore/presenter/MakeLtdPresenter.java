...
public class MakeLtdPresenter extends BasePresent<MakeLtdView> {
    ...
    public void getTags(String shortId){
        ...
        ApiFactory.getInstance().<MakeLtdTabBean>getCompanyTags(params, new TCallback<MakeLtdTabBean>() {
            @Override
    ...
    public void getMakeLtds(int pageIndex,String sortTypeStr,String tag,String movieCompany,String q){
        ...
        try {
            ...
            ApiFactory.getInstance().<TypeListBean>getCompanyInfos(params, new TCallback<TypeListBean>() {
                @Override
