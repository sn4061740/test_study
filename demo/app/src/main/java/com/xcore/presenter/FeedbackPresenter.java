...
public class FeedbackPresenter extends BasePresent<FeedbackView> {
    ...
    public void getFeedbackTypes(){
        ...
        ApiFactory.getInstance().<FeedbackBean>getFeedbackTypes(new TCallback<FeedbackBean>() {
            @Override
    ...
    public void addFeedback(final String categories, final String key){
        ...
        ApiFactory.getInstance().<LikeBean>addFeedback(params, new TCallback<LikeBean>() {
            @Override
    ...
    public void getFeedList(final int pageIndex){
        ...
        ApiFactory.getInstance().<FeedbackRecodeBean>getFeedbackList(params, new TCallback<FeedbackRecodeBean>() {
            @Override
