        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            switch (newState){
                case SCROLL_STATE_IDLE: // The RecyclerView is not currently scrolling.
                    //当屏幕停止滚动，加载图片
                    try {
                        if(getContext() != null)GlideUtils.getInstance().resumeRequests(getContext());
                    }
                    catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                case SCROLL_STATE_SETTLING:
                    ...
                    try {
                        if(getContext() != null)GlideUtils.getInstance().pauseRequests(getContext());
                    }
                    catch (Exception e) {
                        e.printStackTrace();
                    }
