...
//            MobclickAgent.onEvent(RegisterActivity.this, "register_success");
            toMobclickAgentEvent(RegisterActivity.this, "register_success");
        }catch (Exception e){}
        if(registerBean==null){//直接关闭页面
            finish();
            return;
        }
...
//        MainApplicationContext.onWindowFocusChanged(hasFocus,RegisterActivity.this);
//    }
