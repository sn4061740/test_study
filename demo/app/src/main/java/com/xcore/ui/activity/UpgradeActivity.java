...
public class UpgradeActivity extends MvpActivity<UpgradeView,UpgradePresenter> implements UpgradeView {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        final Config config=MainApplicationContext.getConfig();

        setTitle("推广升级");
        setEdit("我的推广",new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean pwdBoo=MainApplicationContext.toGuestLogin(UpgradeActivity.this);
                if(pwdBoo){
                    return;
                }
        ...
        codeTxt.setOnClickListener(new View.OnClickListener() {
            ...
            if("1".equals(guest2)||guest2.length()<=0){//是游客直接跳登录
                LoginActivity.toActivity(UpgradeActivity.this,LoginType.LOGIN);
            }
            }
        });
    }
