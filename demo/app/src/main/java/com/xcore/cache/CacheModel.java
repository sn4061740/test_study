...
public class CacheModel implements Serializable {
    ...
    private boolean isStop=true;//标注是否停止 true:停止中   false:运行中
    ...
    public void setBgSelected(boolean bgSelected) {
    ...
    public void setStreamInfo1(P2PTrans.StreamInfo streamInfo1) {
        this.streamInfo1 = streamInfo1;
    }
