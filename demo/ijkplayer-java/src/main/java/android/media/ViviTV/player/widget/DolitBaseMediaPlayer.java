...
public abstract class DolitBaseMediaPlayer {
    ...
    public static interface  OnRotationChangeListener{
        void onRotationChangeListener();
    }

    public static interface OnErrorListener {
        public boolean onError(Object mp, int what, int extra, long currentPosition);
        public boolean onMediaError(int what);//源失败 100
        public void onOpenError(Exception e,Uri uri);//打开视频失败
    }
