...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public int Init(String strPlayEngineKey1, String strPlayEngineKey2, Context context)
    {
    int keyRet = native_KeyInit(strPlayEngineKey1, strPlayEngineKey2, context);
    if (keyRet != 0)
    {
    return keyRet;
    }
    ...
    private native final int native_KeyInit(String key1, String key2, Context context);
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_ERROR:
                ...
                if(!player.ontifyOnMediaError(MEDIA_ERROR)){
                    player.notifyOnCompletion();
                }
